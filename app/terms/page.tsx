    ...
    <div className="container mx-auto px-4 py-16">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose max-w-none">
          <p className="text-gray-600 mb-6">Last updated: June 22, 2025</p>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              Welcome to SocialGen. These Terms of Service (&quot;Terms&quot;)
              govern your access to and use of the SocialGen website, apps, and
          ...
          <section className="mb-8">
            ...
            <p>
              SocialGen is an AI-powered platform that generates social media
              content for various platforms based on user inputs and
              preferences. Our Service offers features including but not limited
              to content generation, prompt template management, and content
              library storage.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              We reserve the right to disable any user account if we determine
          ...
          <section className="mb-8">
            ...
            <p>
              Price changes will be notified to you in advance. No refunds will
              be issued for partial subscription periods unless required by law.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              &quot;Generated Content&quot; refers to the social media posts,
              captions, and other content produced by our AI based on your
              inputs.
            </p>
            <p className="mb-4">
            ...
            <ul className="list-disc pl-6 mb-4">
              <li>
                We cannot guarantee the uniqueness, accuracy, or appropriateness
              ...
              <li>
                ...
                the terms and policies of the platforms where you publish it
              </li>
            </ul>
            <p>
              We reserve the right to improve our algorithms using anonymized
              patterns from Generated Content.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mb-4">
              <li>
                Generate content that is illegal, defamatory, harmful, abusive,
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              ...
              limited to software, algorithms, logos, and design, are owned by
              SocialGen or its licensors.
            </p>
            <p>
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              not exceed the amount paid by you for the Service during the 12
          ...
          <section>
            ...
            <p className="mt-4">
              ...
              <br />
              <strong>Address:</strong> SocialGen Headquarters, 123 AI Avenue,
