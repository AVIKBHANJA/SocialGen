        ...
        <div className="prose max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              ...
              information when you use our social media post generation service.
            </p>
            <p>
              By accessing or using SocialGen, you agree to the terms of this
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              ...
              or navigate our platform. This information may include:
            </p>
            <ul className="list-disc pl-6 mb-4">
              <li>IP address</li>
            ...
            <p>
              We collect and store the content you create using our platform,
              including prompt templates, generated posts, and any
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              third-party services that have their own privacy policies. We are
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              at the top will be revised. We encourage you to review our Privacy
